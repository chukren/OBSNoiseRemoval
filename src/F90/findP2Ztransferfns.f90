...
!
!
!  findP2Ztransferfns.f
!
!  This program calculates transfer function from pressure noise to 
!  vertical displacement. Intent is to remove gravity wave noise from 
!  vertical to enhance signal, so input will be signal free noise samples 
!  on both components.  Pick a day with no earthquake interference and 
!  select multiple signal-free windows. 
! 
!  Can also detect phase shifts between DPG and Z.

!  Usage: transferp2z  < transferp2zinp
